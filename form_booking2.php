...
<div class="form-row">
    ...
    <div class="col-md-6">
        <label class="col-md-12 control-label" for="port_loading">PORT OF LOADING</label>
        <input id="port_loading" name="port_loading" type="text" placeholder="" class="form-control input-md">

    </div>
    <div class="col-md-4">
        <label class="col-md-6 control-label" for="port_loading">ETD</label>
...
<div class="form-row">
    ...
    <div class="col-md-6">
        <label class="col-md-12 control-label" for="port_discharge">PORT OF DISCHARGE</label>
        <input id="port_discharge" name="port_discharge" type="text" placeholder="" class="form-control input-md">
    </div>
    <div class="col-md-4">
        <label class="col-md-6 control-label" for="port_loading">ETA</label>
...
<div class="form-row">
    ...
    <div class="col-md-6">
        <label class="col-md-12 control-label" for="port_delivery">PORT OF DELIVERY</label>
...
<div class="form-row">
    ...
    <div class="col-md-6">
        <label class="col-md-12 control-label">FEEDER VISSEL</label>
        <input id="feeder_ves" name="feeder_vessel" type="text" placeholder="" class="form-control input-md">

    </div>
    <div class="col-md-6">
        <label class="col-md-12 control-label">FEEDER VOYAGE</label>
...
<div class="form-row">
    ...
    <div class="col-md-6">
        <label class="col-md-12 control-label">MOTHER VESSEL</label>
        <input id="mother_vel" name="mother_vessel" type="text" placeholder="" class="form-control input-md">
    </div>

    <div class="col-md-6">
        <label class="col-md-12 control-label">MOTHER VOYAGE</label>
...
<div class="form-row">
    ...
    <div class="col-md-4">
        <label class="col-md-12 control-label" for="weight">VOLUME</label>
...
<div class="form-row">
    ...
    <div class="col-md-6">
        <label class="col-md-12 control-label" for="weight">Unit</label>
...
<div class="form-row col-6">
    ...
    <div class="col-md-6">
        <label class="col-md-12 control-label" for="weight">QUANTITY</label>
...
<div class="form-row">
    <div class="col-md-12">
        <label class="col-md-12 control-label" for="loading_at">TYPE</label>
...
<div class="form-row">
    ...
    <div class="col-md-6">
        <label class="col-md-12 control-label" for="loading_at">LOADING AT</label>
        <input id="loading_at" name="loading_at" type="text" placeholder="" class="form-control input-md">
    </div>
    <div class="col-md-6">
        <label class="col-md-12 control-label" for="loading_at">TRANSOPTER</label>
...
<div class="form-row">
    ...
    <div class="col-md-6">
        <label class="col-md-12 control-label" for="loading_at">LOADING DATE</label>
        <input id="loading_at" name="loading_date" type="text" placeholder="" class="form-control input-md">
    </div>
    <div class="col-md-6">
        <label class="col-md-6 control-label" for="loading_at">TEL</label>
...
<div class="form-row">
    ...
    <div class="col-md-6">
        <label class="col-md-9 control-label" for="contact">CONTACT </label>
        <input id="contact" name="contact" type="text" placeholder="" class="form-control input-md">
    </div>


    <div class="col-md-6">
        <label class="col-md-12 control-label" for="tel">Shiping Contact</label>
...
<div class="form-row">
    ...
    <div class="col-md-6">
        <label class="col-md-12 control-label" for="contact">CLOSING DATE</label>
        <input name="closing_date" type="text" placeholder="" class="form-control input-md">
    </div>


    <div class="col-md-6">
        <label class="col-md-6 control-label" for="tel">TIME</label>
...
<div class="form-group col-12">
    ...
    <div class="col-md-12">
    <label class="col-md-9 control-label" for="no_of_containner">NO. OF CONTAINER /SIZE /TYPE</label>
